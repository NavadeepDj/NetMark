...
| File | Purpose | Format |
|------|---------|--------|
| `user_data.csv` | Latest uploaded class list (backed up locally) | `Registration Number`, `Name` |
...
```json
{
  "message": "Attendance marked successfully for 20K-0001",
  "status": "success"
}
```
...
```json
{
  ...
  "present": 35,
  "absent": 15,
  "PresentStudents": ["20K-0001", "20K-0002", ...]
}
```
...
```json
{
  ...
  "present_students": ["20K-0001", "20K-0002", ...]
}
```
...
> ⚠️ **Note**: Ensure headers match exactly: `Registration Number` and `Name` (case-sensitive)
